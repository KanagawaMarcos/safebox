...
urlpatterns = [
    ...
    path('box/', varys.views.redirect_login, name='home'),
    ...
    path('box/historico/', varys.views.historico, name='historico'),
    path('box/historico/saque/<int:pk>/deletar', varys.views.WithdrawDelete.as_view(), name='saque-deletar'),
    path('box/historico/evento/<int:pk>/deletar', varys.views.EventSubscriptionDelete.as_view(), name='evento-deletar'),
    path('box/historico/transferencia/<int:pk>/deletar', varys.views.TransferenceDelete.as_view(), name='transferencia-deletar'),
    path('box/historico/deposito/<int:pk>/deletar', varys.views.DepositDelete.as_view(), name='deposito-deletar'),
    path('box/historico/mensal/<int:pk>/deletar', varys.views.MonthlyDepositDelete.as_view(), name='mensal-deletar'),
